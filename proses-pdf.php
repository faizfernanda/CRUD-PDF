...
$pdf->Cell(190, 15, 'Coding State Vocational High School', 0, 1, 'C');
$pdf->SetFont('Times', 'B', 14);
$pdf->Cell(190, 10, 'List of Grade XI Software Engineering Department Students', 0, 1, 'C');
...
$pdf->Cell(35, 7, 'Name' ,1, 0, 'C');
$pdf->Cell(25, 7, 'Gender' ,1, 0, 'C');
$pdf->Cell(75, 7, 'Address', 1, 0, 'C');
